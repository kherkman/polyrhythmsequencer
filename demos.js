...
const demoConfigs = [
    // Demo 1 
    {
        ...
        sequencers: [
            ...
            { id: 2, circles: [{ x: 200, velocity: 90, pan: -0.2 }, { x: 600, velocity: 90, pan: 0.2 }], division: "1/4", channel: "2", note: "38", wavFileName: "Shaker.wav", isMuted: false, volume: 0.6, pan: 0, phase: 0, editMode: "add", presetRhythm: "off" }
        ]
    },
    // Demo 2 
    {
        ...
        sequencers: [
            { id: 1, circles: [{ x: 0, velocity: 110, pan: 0 }, { x: 500, velocity: 110, pan: 0 }], channel: "1", note: "36", wavFileName: "Impact_1.wav", isMuted: false, volume: 0.8, pan: 0, phase: 0, editMode: "add", presetRhythm: "off" },
            ...
            { id: 3, circles: [{ x: 200, velocity: 80, pan: -0.5 }, { x: 400, velocity: 80, pan: 0 }, { x: 600, velocity: 80, pan: 0.5 }, { x: 800, velocity: 80, pan: 0.7 }], channel: "3", note: "42", wavFileName: "Shaker.wav", isMuted: false, volume: 0.5, pan: 0, phase: 0, editMode: "add", presetRhythm: "off" }
        ]
    }
];
